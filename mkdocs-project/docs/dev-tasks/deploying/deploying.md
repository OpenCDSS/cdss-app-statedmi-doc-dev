...
This documentation describes how to create, package, and deploy the StateDMI installer
...
* Java Runtime Environment (JRE) compatible with StateDMI version is packaged with the installer - see [instructions for installing Java](../../dev-env/java8).
...
1. **StateDMI Main Program Code** - The [StateDMI.java](https://github.com/OpenWaterFoundation/cdss-app-statedmi-main/blob/master/src/DWR/DMI/StateDMI/StateDMI.java) file
...
[cdss-app-statedmi-main repository product properties file](https://github.com/OpenWaterFoundation/cdss-app-statedmi-main/blob/master/conf/product.properties)
